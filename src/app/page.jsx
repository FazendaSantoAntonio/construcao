  ...
  return (
    <div className="">
      <div className="w-screen md:h-[600px] flex flex-col justify-center items-start relative">
        <h1 className="md:ml-32 text-primary font-black md:text-5xl text-2xl p-10 md:p-0 ms:w-[500px] uppercase">
          <span className="text-secondary">
            Queijos </span> Artesanais de Alagoa.
        </h1>
        <p className="md:ml-32 ml-10 text-primary/95 mt-5 py-2 border-l border-primary pl-3">
