export default function PoliticaDePrivacidade() {
    return (
        <div className="flex flex-col justify-center items-center p-16 text-primary bg-light">
            ...
            <p>
                Esta Política de Privacidade fornece uma visão geral de nossas práticas de privacidade e das escolhas que você pode fazer, bem como direitos que você pode exercer em relação aos Dados Pessoais tratados por nós. Se você tiver alguma dúvida sobre o uso de Dados Pessoais, entre em contato com contato@apontee.com.br.
            </p><br />
            <p>
            ...
            <p>
                ...
                Caso pretenda exercer qualquer um dos direitos previstos, inclusive retirar o seu consentimento, nesta Política de Privacidade e/ou nas Leis de Proteção de Dados, ou resolver quaisquer dúvidas relacionadas ao Tratamento de seus Dados Pessoais, favor contatar-nos em e-mail contato@apontee.com.br.
            </p><br />
        </div>
    )
}